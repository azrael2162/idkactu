<head>
  ...
  <link rel="icon" height="16px" width="16px" href="image/ico/icon.ico" />
</head>

<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="#"><img height="61px" width="38px" src="image/logo/logo.png" alt=""> IDK.ACTU</a>
